# Graph Report - src  (2026-09-01)

## Corpus Check
- 42 files · ~6,354 words
...
8. `DonutSegment` - 5 edges
9. `DonutPercent` - 5 edges
...
## Knowledge Gaps
- **7 isolated node(s):** `AlertSeverity`, `AlertVariant`, `GeneratorStatus`, `StatIcon`, `Weather` (+2 more)
